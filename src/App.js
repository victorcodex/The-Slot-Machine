...
class App extends Component {
  ...
  //Here, we rotate wheel and generate random symbol
  rotateWheel = () => {
  ...
  // And, we have to see the result after a successful spin and stop
  decideResult = () => {
  ...
  componentDidMount() {
    //start rotation if user doesn't do anything in 5 seconds
    setTimeout(() => {
